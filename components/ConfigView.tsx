...
const ConfigView: React.FC<ConfigViewProps> = ({ data, onUpdateData, currentUser }) => {
  ...
  const handleSaveAuthorities = () => {
      ...
      onUpdateData({
          ...
          // Legacy support (optional, keep subdirector synced with Gestion)
            ...
            <div className="space-y-6">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    ...
                    <p className="text-sm text-slate-500 mb-6">
                        Define los nombres que aparecerán en los formatos oficiales.
                        Estos cambios se aplican globalmente.
                    </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-blue-600 font-bold mt-1 italic">Firma en: Citatorios, Bitácoras y Cuadros de Inasistencias.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-blue-600 font-bold mt-1 italic">Firma en: Cuadros de Concentración de Calificaciones.</p>
                        </div>
