              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 border rounded-xl disabled:bg-slate-100 disabled:text-slate-500"
                ...
                <div>
                  ...
                  <select 
                    ...
                    disabled={!canManageUsers}
                    className="w-full px-4 py-2 border rounded-xl bg-white disabled:bg-slate-100 disabled:text-slate-500"
                  >
                  ...
                  <div className="mb-6 bg-slate-50 p-4 rounded-xl border border-slate-200">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                        <select 
                            ...
                            className="p-2 border rounded-lg text-sm w-20 disabled:bg-slate-100 disabled:text-slate-500"
                        >
                        ...
                        <select 
                            ...
                            className="p-2 border rounded-lg text-sm flex-1 min-w-[150px] disabled:bg-slate-100 disabled:text-slate-500"
                        >
                        ...
                        {assignSubject === 'Tecnología' ? (
                            <>
                                <select 
                                    ...
                                    className="p-2 border rounded-lg text-sm w-40 text-blue-600 font-bold bg-blue-50 border-blue-200 disabled:bg-slate-100 disabled:text-slate-500"
                                >
                                ...
                                <select 
                                    ...
                                    className="p-2 border rounded-lg text-sm w-32 font-bold disabled:bg-slate-100 disabled:text-slate-500"
                                >
                          ...
                          {WEEK_DAYS.map((day: string) => (
                              <div key={day} className="flex flex-col">
                                  ...
                                  <input 
                                      ...
                                      className="text-xs p-2 border rounded-lg focus:ring-1 focus:ring-blue-500 disabled:bg-slate-100 disabled:text-slate-500"
                                      disabled={!canManageUsers}
                                  />
                              </div>
                          ))}
