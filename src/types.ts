...
export interface Student {
  id: string; // Changed to string (CURP)
  name: string;
  curp?: string; // Optional redundancy, ID is the source of truth
...
export interface Citation {
  id: string;
  studentId?: string | null; // Changed to string (CURP)
  studentName: string;
...
export interface VisitLog {
  ...
  studentId?: string | null; // Changed to string
  studentName: string;
  grade: string; 
  group: string; 
  parentName: string; 
...
export interface ScheduleEntry {
  ...
  type?: 'academic' | 'technology' | 'tutoria' | 'support'; // Added 'tutoria' type
}
...
export interface AttendanceRecord {
    ...
    studentId: string; // Changed to string (CURP)
    grade: string;
    group: string;
...
export interface SchoolData {
  ...
  sabanaLayout?: {
      ...
      tutoria: string[]; // Array de teacherIds (Nuevo)
