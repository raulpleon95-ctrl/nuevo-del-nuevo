...
export const generateInitialData = (): SchoolData => {
  ...
  const defaultData: SchoolData = {
    ...
    subdirector: "Nombre del Subdirector(a)", // Mantener legacy
    subdirectorGestion: "Nombre del Subdirector de Gestión", // Nuevo
    subdirectorAcademico: "Nombre del Subdirector Académico", // Nuevo
    teachers: 25,
    studentsCount: 0, 
